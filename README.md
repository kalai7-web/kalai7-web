...
**Sem 2**
<br>Systen Analysis & Design (WBL) >:[SAD](https://github.com/kalai7-web/tis) <br>Programming Technique 2 >:[PT 2](https://github.com/kalai7-web/pt1)<br>Human Computer Interaction >: [HCI](https://github.com/kalai7-web/ds)<br>Computer Organization and Architecture >:[COA](https://github.com/kalai7-web/DL)
